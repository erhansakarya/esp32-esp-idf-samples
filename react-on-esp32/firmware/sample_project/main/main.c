...
#define RUN_REACT_WEBSITE_SPIFFS                                (1)
...
#define RUN_REACT_WEBSITE_SPIFFS_TAG    "RUN_REACT_WEBSITE_SPIFFS"
...
#if RUN_REACT_WEBSITE_SPIFFS
    static const char *BASE_PATH = "/store";

    static const char *REACT_WEB_SITE_TAG = "SERVER";
...
/*******************************************/
    ...
    {
        mdns_init();
        mdns_hostname_set("esp32-react");
        mdns_instance_name_set("Air Quality");
    }
